...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            "Được, chỉ cần mua hub nhiều cổng",
            "Không, vì không thể kéo cáp mạng đi xa như vậy — phải dùng router",
            "Được, nếu hai LAN cùng một tỉnh",
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            "Không được, phải mua máy có khe SIM",
            "Dùng modem GSM 3G/4G/5G có khe SIM rồi phát lại qua sóng Wi-Fi",
            "Dùng thêm một hub nối vào máy",
